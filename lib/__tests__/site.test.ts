...
describe('canonical site helpers', () => {
  ...
  it('generates absolute canonical urls, alternates, and image urls without version helpers', () => {
    expect(getCanonicalUrl('en', 'projects')).toBe(`${siteConfig.baseUrl}/en/projects`)
    expect(getProfileImageUrl('/images/custom.jpg')).toBe(`${siteConfig.baseUrl}/images/custom.jpg`)
