...
export const siteConfig = {
  baseUrl:
    ...
    "https://kevin-martinez-portfolio-alpha.vercel.app",
...
export type CanonicalRoutePath =
  (typeof CANONICAL_ROUTE_PATHS)[CanonicalRouteKey];
...
export const getCanonicalRoutePath = (
  locale: Locale,
...
export const getLocalizedAlternates = (
  routeKey: CanonicalRouteKey = "home",
) => {
...
export const getCanonicalSitemapEntries = () => {
  return locales.flatMap((locale) =>
    (Object.keys(CANONICAL_ROUTE_PATHS) as CanonicalRouteKey[]).map(
      (routeKey) => ({
        locale,
        routeKey,
